...
const NewSectionHero4 = () => {
  return (
    <section className=" rounded-lg flex flex-col items-center py-8 gap-8">
      ...
      <div className="grid grid-cols-4 gap-4">
            {
                hotelsExamples.map((modal)=>(
                    <div className="flex shadow-lg px-8 py-6 gap-4 rounded-lg bg-white">
                        <div className="h-16 w-16 overflow-hidden bg-white rounded-full shadow-md ">

                        <Image src={modal.image} alt="hotel" className="w-full h-full rounded-full"/>
                        </div>
